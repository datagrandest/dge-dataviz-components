...
* `dge-figure`: [téléchargement](./dist/4.5.0/dge-figure.js){:target="_blank"}
* `dge-table`: [téléchargement](./dist/4.5.0/dge-table.js){:target="_blank"}
* `dge-chart`: [téléchargement](./dist/4.5.0/dge-chart.js){:target="_blank"}
* `dge-text`: [téléchargement](./dist/4.5.0/dge-text.js){:target="_blank"}
* `dge-image`: [téléchargement](./dist/4.5.0/dge-image.js){:target="_blank"}
...
* `dge-all`: [téléchargement](./dist/4.5.0/dge-all.js){:target="_blank"}
...
!!! Info "Package pour démarrer"
    ...
    * [Format ZIP](dist/4.5.0/dist_4.5.0.zip)
    * [Format 7Z](dist/4.5.0/dist_4.5.0.7z)
